...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@velq/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@velq/adapter-utils").TranscriptEntry[];
