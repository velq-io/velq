 ...
 *
 * This is placed on `globalThis.__velqPluginBridge__` and consumed by
...
declare global {
  ...
  var __velqPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__velqPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__velqPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
