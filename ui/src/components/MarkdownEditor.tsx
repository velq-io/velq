  ...
  return (
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("velq-mdxeditor", !bordered && "velq-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "velq-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
