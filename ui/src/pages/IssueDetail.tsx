...
import type { ActivityEvent } from "@velq/shared";
import type { Agent, IssueAttachment } from "@velq/shared";
...
export function IssueDetail() {
  ...
  const attachmentUploadButton = (
    <>
      ...
      >
        <Velq className="h-3.5 w-3.5 mr-1.5" />
      ...
      <Tabs value={detailTab} onValueChange={setDetailTab} className="space-y-3">
        ...
        <TabsContent value="comments">
          <CommentThread
            ...
            agentMap={agentMap}
            draftKey={`velq:issue-comment-draft:${issue.id}`}
            enableReassign
