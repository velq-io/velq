...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within VelqPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the Velq host.
 *
...
export interface VelqPluginManifestV1 {
   ...
   */
  minimumVelqVersion?: PluginMinimumHostVersion;
