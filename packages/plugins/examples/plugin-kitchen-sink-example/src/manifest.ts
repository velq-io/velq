...
const manifest: VelqPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Velq plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Velq",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Velq domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
