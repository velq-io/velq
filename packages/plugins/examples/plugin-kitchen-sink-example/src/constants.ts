import type { PluginLauncherRegistration } from "@velq/plugin-sdk";

export const PLUGIN_ID = "velq-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".velq-kitchen-sink-demo.txt",
} as const;
