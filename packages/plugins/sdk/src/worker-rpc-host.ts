...
import type { VelqPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@velq/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: VelqPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@velq/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
