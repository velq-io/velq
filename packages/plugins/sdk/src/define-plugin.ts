/**
 * `definePlugin` — the top-level helper for authoring a Velq plugin.
 *
...
// ---------------------------------------------------------------------------
// VelqPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 * @returns A sealed `VelqPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@velq/plugin-sdk";
