...
description: >
  Generate the stable Velq release changelog at releases/vYYYY.MDD.P.md by
  reading commits, changesets, and merged PR context since the last stable tag.
---

# Release Changelog Skill

Generate the user-facing changelog for the **stable** Velq release.

## Versioning Model

Velq uses **calendar versioning (calver)**:
...
```
- **Feature name** — Description. ([#123](https://github.com/velq-io/velq/pull/123), @contributor1, @contributor2)
```
