...
Detailed reference for the Velq control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "Velq Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "velq-mobile",
    "cwd": "/Users/me/velq-mobile",
    "repoUrl": "https://github.com/acme/velq-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `velq-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
