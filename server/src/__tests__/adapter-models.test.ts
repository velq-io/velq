...
import { models as codexFallbackModels } from "@velq/adapter-codex-local";
import { models as cursorFallbackModels } from "@velq/adapter-cursor-local";
import { resetOpenCodeModelsCacheForTests } from "@velq/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.VELQ_OPENCODE_COMMAND;
  ...
  it("returns no opencode models when opencode command is unavailable", async () => {
    process.env.VELQ_OPENCODE_COMMAND = "__velq_missing_opencode_command__";
