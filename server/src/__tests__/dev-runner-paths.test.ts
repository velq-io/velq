...
describe("shouldTrackDevServerPath", () => {
  it("ignores repo-local Velq state and common test file paths", () => {
    expect(
      shouldTrackDevServerPath(
        ".velq/worktrees/PAP-712-for-project-configuration-get-rid-of-the-overview-tab-for-now/.agents/skills/velq",
      ),
    ).toBe(false);
