...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@velq/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: VelqPluginManifestV1, pluginDbId?: string): void;
