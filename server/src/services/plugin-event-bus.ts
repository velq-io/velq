/**
 * PluginEventBus — typed in-process event bus for the Velq plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@velq/shared";
import type { PluginEvent, EventFilter } from "@velq/plugin-sdk";
