...
import { companySecrets, companySecretVersions } from "@velq/db";
import type { AgentEnvConfig, EnvBinding, SecretProvider } from "@velq/shared";
import { envBindingSchema } from "@velq/shared";
