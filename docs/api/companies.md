...
Manage companies within your Velq instance.
...
Company logo uploads use the normal Velq attachment size limit.
...
| `logoUrl` | string | Optional Velq asset content path for the stored logo image |
