/**
 * esbuild configuration for building the velq CLI for npm.
 *
 * Bundles all workspace packages (@velq/*) into a single file.
...
// to npm and resolved at runtime (e.g. @velq/server uses dynamic import).
