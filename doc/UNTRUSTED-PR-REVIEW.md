...
This is intentionally separate from the normal Velq dev image.
...
```sh
review-checkout-pr velq/velq 432
cd /work/checkouts/velq-velq/pr-432
```
...
## Preview the Velq app from the PR
...
- Velq's embedded PostgreSQL and local storage stay inside the container home volume via `VELQ_HOME=/home/reviewer/.velq-review`.
